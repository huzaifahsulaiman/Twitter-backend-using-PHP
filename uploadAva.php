...
// STEP 2. Create a folder for user with name of his ID -- only to save avatar
$folder = "/Applications/XAMPP/xamppfiles/htdocs/Twitter/ava/" . $id;

// if folder doesn't exist
if (!file_exists($folder)) {
    mkdir($folder, 0755, true); //0777 permission
}
...
if (move_uploaded_file($_FILES["file"]["tmp_name"], $folder)) { //tmp means temporary
...
$path = "http://localhost/Twitter/ava/" . $id . "/ava.jpg";
