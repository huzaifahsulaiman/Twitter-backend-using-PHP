...
class email {
    ...
    function confirmationTemplate() {
        ...
        // open confirmationtemplate file
        $file = fopen("templates/confirmationTemplate.html", "r") or die("Unable to open file"); //r means open for Reading
    ...
    function sendEmail($details) {
        ...
        $headers .= "From:  " . $fromName . "<" . $fromEmail . ">" . "\r\n";// From Huzaifah Sulaiman <huzaifah@gmail.com>
